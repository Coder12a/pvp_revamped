...
pvp_revamped.config.barrel_roll_speed = tonumber(minetest.settings:get("pvp_revamped.barrel_roll_speed")) or 1.5
pvp_revamped.config.disarm_chance_mul = tonumber(minetest.settings:get("pvp_revamped.disarm_chance_mul")) or 2
pvp_revamped.config.leg_immobilize_mul = tonumber(minetest.settings:get("pvp_revamped.leg_immobilize_mul")) or 0.8
pvp_revamped.config.knee_immobilize_mul = tonumber(minetest.settings:get("pvp_revamped.knee_immobilize_mul")) or 1.5
pvp_revamped.config.immobilize_mul = tonumber(minetest.settings:get("pvp_revamped.immobilize_mul")) or 500000
...
pvp_revamped.config.block_pool_mul = tonumber(minetest.settings:get("pvp_revamped.block_pool_mul")) or 4
...
pvp_revamped.config.elevated_dmg_mul = tonumber(minetest.settings:get("pvp_revamped.elevated_dmg_mul")) or 1.1
...
pvp_revamped.config.optimal_distance_dmg_mul = tonumber(minetest.settings:get("pvp_revamped.optimal_distance_dmg_mul")) or 1.1
pvp_revamped.config.maximum_distance_dmg_mul = tonumber(minetest.settings:get("pvp_revamped.maximum_distance_dmg_mul")) or 0.9
